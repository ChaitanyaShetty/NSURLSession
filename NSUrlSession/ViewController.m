...
//  NSUrlSession
//
//  Created by chaitanya on 02/10/16.
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //}
    cell.lb1.text = [self.artistDetails objectAtIndex:indexPath.row];
    cell.lb2.text = [self.bundleIdDetails objectAtIndex:indexPath.row];
...
//    cell.imgOutlet.image = img;
  [cell.imgOutlet setImage:[UIImage imageWithData:imgData]];
